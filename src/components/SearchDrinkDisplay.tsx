...
const SearchDrinkDisplay = (props: Props) => {
  ...
  const searchDrinkDisplay = products.map(p =>
  ...
  return (
    <div style={{ backgroundColor: bg }}>
      <Button id='top' style={{ color: 'white', fontSize: 12 }} disabled>Drinks:</Button>
...
export default SearchDrinkDisplay